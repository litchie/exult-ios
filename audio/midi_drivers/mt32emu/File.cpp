...
AbstractFile::AbstractFile() : sha1DigestCalculated(false), reserved(nullptr) {
	sha1Digest[0] = 0;
}

AbstractFile::AbstractFile(const SHA1Digest &useSHA1Digest) : sha1DigestCalculated(true), reserved(nullptr) {
