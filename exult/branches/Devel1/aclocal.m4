...
# FIXME:
# I don't know if this would apply to all versions of FreeBSD, although
# based on what I've been told by jdp, I would assume it *should* work
# but hey, if someone actually wants to test this, go right ahead.
freebsdelf* | freebsd[34]*)
  lt_cv_deplibs_check_method=pass_all
  ;;
