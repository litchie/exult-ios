...
Paperdoll_gump::Paperdoll_npc Paperdoll_gump::Characters_BG[] = {
	...
	// Janna
	{  490,  true,  13,  0, 155,  0,  1,   7,  0,  2,  4 },

	// Sentri
	{  462, false,  14,  0, 158,  0,  1,   7,  1,  3,  5 },

	// Julia
	{  454,  true,  13,  0, 127,  0,  1,   7,  0,  2,  4 },

	// Katrina
	{  452,  true,  13,  0, 127,  0,  1,   7,  0,  2,  4 },

	// Tseramed
	{  460, false,  14,  0, 156,  0,  1,   7,  1,  3,  5 },

	// Spark
	{  489, false,  14,  0, 158,  0,  1,   7,  1,  3,  5 },
	...
	{  259, false,  14,  0, 158,  0,  1,   7,  1,  3,  5 },
	// Ghost
	{  299,  true,  13,  3, 137,  0,  1, 136,  0,  2,  4 },
	// Blacksmith
...
Paperdoll_gump::Paperdoll_item Paperdoll_gump::Items_BG[] =
{
	...
	{     582,  9,       Actor::neck,   OT_Normal,  false,    -1,     0 },
	// Gorget **NEEDS ART**
	{     586,  9,       Actor::neck,   OT_Normal,  false,    -1,     0 },
	// Magic Gorget **NEEDS ART**
	{     843,  9,       Actor::neck,   OT_Normal,  false,    -1,     0 },
	// Ankh
	{     955,  0,       Actor::neck,   OT_Normal,  false,     0,     0 },
	// Fellowship
	{     955,  1,       Actor::neck,   OT_Normal,  false,     0,     1 },
	// White Heart??? **NEEDS ART**
	{     955,  2,       Actor::neck,   OT_Normal,  false,     0,     5 },
	// Amulet of Protection???
	{     955,  3,       Actor::neck,   OT_Normal,  false,     0,     3 },
	// Amulet of ???
	...
	{     955,  7,       Actor::neck,   OT_Normal,  false,     0,     6 },
	// Forge Amluet **NEEDS ART**???
	{     955,  8,       Actor::neck,   OT_Normal,  false,     0,     6 },
	// Forge Amluet **NEEDS ART**???
	{     955,  9,       Actor::neck,   OT_Normal,  false,     0,     6 },
	// Forge Amluet **NEEDS ART**???
	{     955, 10,       Actor::neck,   OT_Normal,  false,     0,     6 },


	// CLOAKS
	
	// Cloak
	{     285,  1, Actor::cloak_spot,   OT_Normal,  false,      8,    0,     -1 },
	{     285,  1, Actor::special_spot, OT_Normal,   true,      8,    1,     -1 },
	// Cloak
	{     227,  3, Actor::cloak_spot,   OT_Normal,  false,    116,    0,     -1 },
	{     227,  3, Actor::special_spot, OT_Normal,   true,    116,    1,     -1 },
	// Cloak **NEEDS ART**
	{     285,  3, Actor::cloak_spot,   OT_Normal,  false,    164,    0,     -1 },
	{     285,  3, Actor::special_spot, OT_Normal,   true,    164,    1,     -1 },


	// ARMOUR
	
	// Top **NEEDS ART**
	{     249,  0,      Actor::torso,   OT_Shield,   true,    -1,     0,      2,   4,  6 },
	// Top **NEEDS ART**
	{     249,  1,      Actor::torso,   OT_Shield,   true,    -1,     0,      2,   4,  6 },
	// Top **NEEDS ART**
	{     249,  2,      Actor::torso,   OT_Shield,   true,    -1,     0,      2,   4,  6 },
	// Leather
	{     569, -1,      Actor::torso,   OT_Shield,   true,    57,     0,      2,   4,  6 },
	// Scale
	{     570, -1,      Actor::torso,   OT_Shield,   true,    92,     0,      2,   4,  6 },
	...
	{     383, 0,        Actor::head,     OT_Helm,   true,    74,     0 },
	// Hood **NEEDS ART**
	{     444, 0,        Actor::head,     OT_Helm,   true,    59,     0 },
	// Hood **NEEDS ART**
	{     444, 1,        Actor::head,     OT_Helm,   true,    59,     0 },
	// Chain Coif
	{     539, 0,        Actor::head,     OT_Helm,   true,    24,     0 },
	// Great Helm
	{     541, 0,        Actor::head,     OT_Helm,   true,    30,     0 },
	...
	{     542, 0,        Actor::head,     OT_Helm,   true,    31,     0 },
	// Caddelite **NEEDS ART**
	{     638, 1,        Actor::head,     OT_Helm,   true,   162,     0 },
	// Leather Helm
	{    1004, 0,        Actor::head,     OT_Helm,   true,    59,     0 },
	...
	// Greaves **NEEDS ART** ???
	{     353, -1,        Actor::legs,     OT_Normal,   true,    87,     0 },
	// Leather
	{     574, -1,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Chain
	{     575, -1,        Actor::legs,     OT_Normal,   true,    26,     0 },
	...
	{     686, -1,        Actor::legs,     OT_Normal,   true,    72,     0 },
	// Pants **NEEDS ART**
	{     738,  0,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Pants **NEEDS ART**
	{     738,  1,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Pants **NEEDS ART**
	{     738,  2,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Pants **NEEDS ART**
	{     738,  3,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Pants **NEEDS ART**
	{     738,  4,        Actor::legs,     OT_Normal,   true,    60,     0 },
	// Pants **NEEDS ART**
	{     738,  5,        Actor::legs,     OT_Normal,   true,    60,     0 },
	...
	{     296, 0,      Actor::rfinger,   OT_Normal,  false,   120,     1,      3,   5 },
	// Ring of Protection
	{     297, 0,      Actor::lfinger,   OT_Normal,  false,   148,     0,      2,   4  },
	{     297, 0,      Actor::rfinger,   OT_Normal,  false,   148,     1,      3,   5 },
	// Ring of Regeneration
	...
	// Shoes **NEEDS ART**
	{     585, 0,         Actor::feet,   OT_Normal,   true,    -1,     0 },
	// Leather
	{     587, 0,         Actor::feet,   OT_Normal,   true,    58,     0 },
	// Magic
	{     587, 1,         Actor::feet,   OT_Normal,   true,    73,     0 },
	...
	{     550, -1,      Actor::lhand,   OT_Single,  false,    16,     0 },
	{     550, -1,       Actor::belt,   OT_Single,  false,    16,     1 },
	// Fire Sword
	{     551, -1,      Actor::lhand,   OT_Single,  false,    41,     0 },
	{     551, -1,       Actor::belt,   OT_Single,  false,    41,     1 },
	// Magic Axe
	...
	{     552, -1,       Actor::belt,   OT_Single,  false,    77,     1 },
	// Hawk **NEEDS ART**
	{     555, -1,      Actor::lhand,   OT_Single,  false,    -1,     0 },
	{     555, -1,       Actor::belt,   OT_Single,  false,    -1,     1 },
	// Magebane
	{     559, -1,      Actor::lhand,   OT_Single,  false,    67,     0},
	{     559, -1,       Actor::belt,   OT_Single,  false,    67,     1},
	// Great Dagger **NEEDS ART**
	{     561, -1,      Actor::lhand,   OT_Single,  false,    35,     0 },
	{     561, -1,       Actor::belt,   OT_Single,  false,    35,     1 },
	// Blowgun
	{     563, -1,      Actor::lhand,   OT_Single,  false,    12,     0 },
	{     563, -1,       Actor::belt,   OT_Single,  false,    12,     1 },
	// Poisoned Dagger
	...
	{     565, -1,      Actor::lhand,   OT_Single,  false,    -1,     0 },
	{     565, -1,       Actor::belt,   OT_Single,  false,    -1,     1 },
	// Sword of Defense
	{     567, -1,      Actor::lhand,   OT_Single,  false,   110,     0 },
	{     567, -1,       Actor::belt,   OT_Single,  false,   110,     1 },
	// Club
	...
	{     591, -1,      Actor::lhand,   OT_Single,  false,   107,     0 },
	{     591, -1,       Actor::belt,   OT_Single,  false,   107,     1 },
	// Spear
	{     592, -1,      Actor::lhand,    OT_Staff,  false,   103,     0 },
	{     592, -1,       Actor::back,    OT_Staff,  false,   103,     1 },
	// Throwing Axe
	...
	{     608, -1,       Actor::belt,   OT_Single,  false,   109,     1 },
	// Cleaver **NEEDS ART**
	{     614, -1,      Actor::lhand,   OT_Single,  false,    -1,     0 },
	{     614, -1,       Actor::belt,   OT_Single,  false,    -1,     1 },
	// Knives **NEEDS ART**
	{     615, -1,      Actor::lhand,   OT_Single,  false,    -1,     0 },
	{     615, -1,       Actor::belt,   OT_Single,  false,    -1,     1 },
	// Whip
	{     622, -1,      Actor::lhand,   OT_Single,  false,   115,     0 },
	{     622, -1,       Actor::belt,   OT_Single,  false,   115,     1 },
	// Hammer
	...
	{     630, -1,       Actor::belt,   OT_Single,  false,    42,     1 },
	// Dragon Slayer Sword
	{     635, -1,      Actor::lhand,   OT_Single,  false,   143,     0 },
	{     635, -1,       Actor::belt,   OT_Single,  false,   143,     1 },
	// Serpentine Dagger
	{     636, -1,      Actor::lhand,   OT_Single,  false,    95,     0 },
	{     636, -1,       Actor::belt,   OT_Single,  false,    95,     1 },
	// Serpentine Sword
	...
	{     548, -1,      Actor::lhand,    OT_Staff,  false,    52,     0 },
	{     548, -1,Actor::back2h_spot,    OT_Staff,  false,    52,     1 },
	// Firedoom Staff
	{     553, -1,      Actor::lhand,    OT_Staff,  false,    43,     0 },
	{     553, -1,Actor::back2h_spot,    OT_Staff,  false,    43,     1 },
	// Jugganaught Hammer
	...
	{     562, -1,      Actor::lhand,    OT_Staff,  false,    93,     0 },
	{     562, -1,Actor::back2h_spot,    OT_Staff,  false,    93,     1 },
	// Pitchfork
	{     589, -1,      Actor::lhand,    OT_Staff,  false,    84,     0 },
	{     589, -1,Actor::back2h_spot,    OT_Staff,  false,    84,     1 },
	// Two Handed Hammer
	...
	{     885, -1,      Actor::lhand,    OT_Staff,  false,    -1,     0 },
	{     885, -1,Actor::back2h_spot,    OT_Staff,  false,    -1,     1 },
	...
	{     647, -1,      Actor::lhand, OT_Crossbow,  false,     32,    0 },
	{     647, -1,       Actor::belt, OT_Crossbow,  false,     32,    1 },
	// Bolts
	{     723, 25,       Actor::ammo, OT_Crossbow,  false,    132,    2,      2, 0 },
	{     723, 26,       Actor::ammo, OT_Crossbow,  false,    132,    3,      2, 0 },
	{     723, 27,       Actor::ammo, OT_Crossbow,  false,    132,    3,      3, 0 },
	...
	// Musket **NEEDS ART**
	{     278, -1,      Actor::lhand,   OT_Single,  false,    -1,     0 },
	{     278, -1,Actor::back2h_spot,   OT_Single,  false,    -1,     1 },
	// Ammunition **NEEDS ART**
	{     581, -1,       Actor::ammo,      OT_Bow,  false,    -1,    2,      1, 0 },
