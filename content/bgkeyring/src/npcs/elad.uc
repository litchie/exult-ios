...
Elad 0x4A2 ()
{
	if (event == DOUBLECLICK)
	{
		...
		if (!gflags[MET_ELAD])
		{
			...
			ELAD.say("Elad bows in your direction.~@My pleasure to see thee again.@");
