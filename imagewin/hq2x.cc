...
#define PIXEL00_0     StoreRGB(pc, c[5], manip);
...
#define PIXEL01_0     *((int*)(dest+4)) = c[5];
...
#define PIXEL10_0     *((int*)(dest+BpL)) = c[5];
...
#define PIXEL11_0     *((int*)(dest+BpL+4)) = c[5];
